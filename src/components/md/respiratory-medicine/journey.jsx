  ...
  return (
    <div>
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
       ...
       Build a rewarding career in respiratory healthcare with an MD in Pulmonology (Respiratory Medicine).
 Let All About Doctor Education Pvt. Ltd. guide you from counselling to admission with personalized support and global opportunities.
          </p>
