...
const AdmissionProcess = () => {
  const steps = [
    ...
    "Receive university shortlisting and guidance from All About Doctor Education Pvt. Ltd.",
    "Complete admission formalities, documentation, and hostel/visa assistance (for international universities).",
  ];
