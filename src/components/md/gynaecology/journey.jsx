    ...
    <div>
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
         ...
         Ready to become a skilled gynecologist with an MD in Gynaecology?
 Let All About Doctor Education Pvt. Ltd. guide you through every step — from application to specialization.
          </p>
