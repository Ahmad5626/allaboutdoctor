import { Baby, HeartPulse, Microscope, Building2, GraduationCap } from "lucide-react";
  ...
  const careerOptions = [
    {
      ...
      title: "Consultant Gynecologist or Obstetrician",
    },
    {
      icon: <Baby className="w-8 h-8 text-primary" />,
      title: "Fertility and IVF Specialist",
    },
    {
      icon: <HeartPulse className="w-8 h-8 text-primary" />,
      title: "Maternal-Fetal Medicine Expert",
    },
    {
      icon: <GraduationCap className="w-8 h-8 text-primary" />,
      title: "Academic Faculty or Researcher",
    },
    {
      icon: <Building2 className="w-8 h-8 text-primary" />,
      title: "Public Health Advisor or Hospital Administrator",
    },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10">
          ...
          >
            ...
            <span className="text-primary">MD in Gynaecology</span>
          </h1>
