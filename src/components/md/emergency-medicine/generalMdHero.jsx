      ...
      <header className="relative overflow-hidden border-b border-border">
        <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
          ...
          >
            ...
            <span className="text-primary">Emergency Medicine</span>
          </h1>

          <p className="text-lg md:text-xl text-primary font-semibold">
            All About Doctor Education Pvt. Ltd. provides complete admission and
            career guidance for pursuing MD in Emergency Medicine, a postgraduate
            program dedicated to managing acute illnesses and life-threatening
            medical emergencies.
          </p>

          <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
            This specialization equips doctors with the knowledge and hands-on
            training required to stabilize critically ill patients, manage trauma,
            cardiac arrests, strokes, and other emergency conditions using advanced
            resuscitation and diagnostic techniques. With rising healthcare demands
            and global recognition, Emergency Medicine stands as one of the most
            dynamic and impactful fields in modern medicine.
          </p>
