...
const AdmissionProcess = () => {
  const steps = [
    ...
    "Get university shortlisting and expert guidance from All About Doctor Education Pvt. Ltd.",
    "Complete documentation, hostel, and visa assistance (for international programs).",
  ];
