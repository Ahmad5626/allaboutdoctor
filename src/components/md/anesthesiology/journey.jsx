...
const Journey = () => {
  return (
    <div>
      ...
      Build a rewarding medical career with an MD in Anesthesiology and master the art of patient safety, anesthesia, and critical care.
 Let All About Doctor Education Pvt. Ltd. guide you with expert counselling, trusted admissions, and comprehensive career support.
          </p>
