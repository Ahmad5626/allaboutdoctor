import { Stethoscope, ActivitySquare, Building2, GraduationCap, HeartPulse } from "lucide-react";
  ...
  const careerOptions = [
    {
      ...
      title: "Consultant Anesthesiologist or Pain Specialist",
    },
    {
      icon: <HeartPulse className="w-8 h-8 text-primary" />,
      title: "Critical Care or ICU Expert",
    },
    {
      icon: <Building2 className="w-8 h-8 text-primary" />,
      title: "Hospital Administrator or Medical Officer",
    },
    {
    ...
    },
    {
      ...
      title: "Anesthesia Consultant in Surgical and Trauma Units",
    },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10">
          ...
          >
            ...
            <span className="text-primary">MD in Anesthesiology</span>
          </h1>
