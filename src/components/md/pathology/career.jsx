import { Microscope, FlaskConical, Building2, GraduationCap, Dna } from "lucide-react";
  ...
  const careerOptions = [
    {
      ...
      title: "Consultant Pathologist in hospitals or private labs",
    },
    {
      icon: <FlaskConical className="w-8 h-8 text-primary" />,
      title: "Laboratory Director or Diagnostic Specialist",
    },
    {
      icon: <GraduationCap className="w-8 h-8 text-primary" />,
      title: "Medical College Faculty or Academic Researcher",
    },
    {
      icon: <Dna className="w-8 h-8 text-primary" />,
      title: "Clinical Research Scientist in pharmaceutical or biotech firms",
    },
    {
      icon: <Building2 className="w-8 h-8 text-primary" />,
      title: "Forensic Pathologist or Cytology Expert",
    },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10">
          ...
          >
            ...
            <span className="text-primary">MD in Pathology</span>
          </h1>
