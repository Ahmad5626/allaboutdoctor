    ...
    <div>
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          Ready to advance your medical career with an MD in Dermatology?
 Let All About Doctor Education Pvt. Ltd. guide you every step of the way — from counselling to admission and beyond.
          </p>
