import { Stethoscope, GraduationCap, Microscope, Building2, UserCheck } from "lucide-react";
  ...
  const careerOptions = [
    {
      ...
      title: "Consultant Physician or Hospitalist",
    },
    {
      icon: <UserCheck className="w-8 h-8 text-primary" />,
      title: "Super-specialist after DM or Fellowship",
    },
    {
    ...
    },
    {
      ...
      title: "Public Health Expert or Administrator",
    },
    {
      icon: <Microscope className="w-8 h-8 text-primary" />,
      title: "Private Practitioner or Telemedicine Consultant",
    },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <div className=" mb-10">
          ...
          >
            ...
            <span className="text-primary">MD in General Medicine</span>
          </h1>
