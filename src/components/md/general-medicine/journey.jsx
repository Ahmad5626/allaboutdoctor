      ...
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
           Ready to become a skilled physician with an MD in General Medicine?
 Let All About Doctor Education Pvt. Ltd. guide you from application to specialization with end-to-end support.
          </p>
