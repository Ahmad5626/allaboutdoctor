...
const Faq = () => {
  ...
  const faqs = [
    {
      q: "What is the duration of MD General Medicine?",
      a: "It is a 2–3 year full-time postgraduate program.",
    },
    {
      q: "Is NEET-PG mandatory for admission?",
      a: "Yes, NEET-PG or equivalent qualification is required.",
    },
    {
      q: "Can I pursue this program abroad?",
      a: "Yes, All About Doctor Education Pvt. Ltd. assists with recognized international MD/Clinical Medicine universities offering globally valid degrees.",
    },
    {
      q: "What is the scope after MD in General Medicine?",
      a: "Graduates can practice as consultant physicians, pursue DM programs, or work in hospitals, academia, or public health.",
    },
  ];
