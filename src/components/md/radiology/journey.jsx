    ...
    <div>
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
         ...
         Advance your medical career with MD in Radiology and master the art of medical imaging and diagnosis.
 Let All About Doctor Education Pvt. Ltd. guide you with expert counselling, transparent processes, and personalized admission support.
          </p>
