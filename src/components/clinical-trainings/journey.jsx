      ...
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
           Gain hands-on medical experience and practical skills with All About Doctor Education Pvt Ltd. Schedule your clinical training program today and take a step closer to becoming a confident, skilled global doctor.
          </p>
