    ...
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        <h1
            ...
            >
           Clinical Trainings <span className="text-primary">About All About Doctor Education Pvt Ltd</span> 
            ...
            <p className="text-lg md:text-xl text-primary font-semibold">
           Practical medical training & hands-on exposure for aspiring doctors.

          </p>
        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
         At All About Doctor Education Pvt Ltd, we provide students with real-world clinical experience to enhance their medical knowledge, skills, and confidence. Our clinical training programs are designed to complement academic learning and prepare students for global medical practice.
        </p>
