    ...
    <div>
      ...
      <section className="md:py-0 px-4 md:px-8 border-b border-primary/20 bg-primary/5">
        <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
          ...
          >
            BAMS Course <span className="text-primary">Overview</span>
          </h1>
          ...
          <div className="overflow-x-auto py-6">
            <table className="w-full border-collapse">
              <tbody>
                {[
                  { label: "Course Name", value: "Bachelor of Ayurvedic Medicine and Surgery (BAMS)" },
                  { label: "Duration", value: "5.5 years (4.5 academic + 1-year internship)" },
                  { label: "Eligibility", value: "10+2 with Physics, Chemistry, Biology (min. 50%) and NEET qualification" },
                  { label: "Entrance Exam", value: "NEET-UG (Mandatory)" },
                  { label: "Course Type", value: "Undergraduate – Professional" },
                  { label: "Degree Awarded By", value: "AYUSH-recognised University / Govt. Approved Institution" },
                ].map((row, idx) => (
                  <tr
                    key={idx}
