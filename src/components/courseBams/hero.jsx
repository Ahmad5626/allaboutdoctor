  ...
  return (
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        >
          BAMS – <span className="text-primary">Bachelor of Ayurvedic Medicine and Surgery</span>
        </h1>

        <p className="text-lg md:text-xl text-primary font-semibold">
          Begin your Ayurvedic medical journey with All About Doctor Education Pvt. Ltd.
        </p>

        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
          India’s most trusted medical education consultancy. We guide aspiring Ayurveda doctors
          toward successful admissions in AYUSH-recognised universities across India and abroad —
          ensuring transparent counselling, expert guidance, and ethical support throughout your
          admission process.
        </p>
