...
export default function NeetStateCoveragePremium() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-20 max-w-3xl">
          <h2 className="text-5xl lg:text-6xl font-bold leading-tight bg-gradient-to-r from-primary via-blue-200 to-secondary bg-clip-text text-transparent animate-shimmer fade-item">
            All India & State-Wise NEET UG Counselling Coverage
          </h2>

          <p className="mt-6 text-lg text-white/80">
           We provide counselling guidance for all Indian states, including but not limited to
          </p>
        </div>
        ...
        <p className="mt-20 text-base md:text-lg text-white/80 max-w-4xl">
          Each state has specific rules, cut-offs, and counselling schedules.
        </p>
