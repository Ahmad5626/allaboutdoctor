    ...
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        <h1
            ...
            >
          Learning Hub <span className="text-primary">About All About Doctor Education Pvt Ltd</span> 
            ...
            <p className="text-lg md:text-xl text-primary font-semibold">
          Digital learning materials, webinars, workshops for aspiring doctors.

          </p>
        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
          At All About Doctor Education Pvt Ltd, our Learning Hub provides students with comprehensive digital resources to enhance their medical knowledge and skills. From interactive webinars to curated study materials and practical workshops, we empower students to stay ahead in their academic journey and prepare for global medical careers.
        </p>
