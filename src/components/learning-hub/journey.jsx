    ...
    <div>
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
         ...
         Enhance your knowledge, skills, and exam readiness with All About Doctor Education Pvt Ltd Learning Hub. Join our digital resources, webinars, and workshops to take your medical education to the next level.
          </p>
