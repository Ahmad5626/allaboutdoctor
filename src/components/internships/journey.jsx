  ...
  return (
    <div>
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
        ...
        Gain practical experience, enhance your medical skills, and prepare for your global medical career with All About Doctor Education Pvt Ltd.el.
          </p>
          <button className="px-8 py-4 bg-white text-primary rounded-lg font-bold hover:scale-105 transition text-lg">
          <Link href="/services">

          Book Your Internship Now
          </Link>
          </button>
        </div>
      </section>
