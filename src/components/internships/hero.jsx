    ...
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        <h1
            ...
            >
         Internship Programs <span className="text-primary">About All About Doctor Education Pvt Ltd</span> 
            ...
            <p className="text-lg md:text-xl text-primary font-semibold">
          Internship programs for students in hospitals and universities.

          </p>
        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
         At All About Doctor Education Pvt Ltd, we provide structured internship opportunities that allow aspiring doctors to gain hands-on experience in real medical environments. Our programs are designed to complement academic learning, strengthen clinical skills, and prepare students for successful medical careers.
        </p>
