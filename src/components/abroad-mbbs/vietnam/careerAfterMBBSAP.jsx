...
const CareerAfterMBBSVietnam = () => {
  const careers = [
    ...
    },
    {
      ...
      title: "NExT exam preparation (for India)",
    },
    {
      icon: <Building2 className="w-8 h-8 text-primary" />,
      title: "Government/Private clinical roles",
    },
    {
    ...
    },
    {
      ...
      title: "Research & academic careers",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Vietnam</span>
        </h1>
...
export default CareerAfterMBBSVietnam;
