...
const FaqVietnam = () => {
  ...
  const faqs = [
    {
      q: "Is Vietnam good for MBBS for Indian students?",
      a: "Yes, Vietnam offers affordable fees, modern hospitals, and strong clinical practice.",
    },
    {
      q: "Is NEET required for MBBS in Vietnam?",
      a: "Yes, NEET qualification is compulsory for Indian students.",
    },
    {
      q: "Which regions are best for MBBS in Vietnam?",
      a: "Ho Chi Minh, Hanoi, Da Nang, Buon Ma Thuot, and Can Tho.",
    },
    {
      q: "Is the MBBS degree valid in India?",
      a: "Yes, after clearing NExT as per NMC guidelines.",
    },
    {
      q: "Does All About Doctor provide complete Vietnam MBBS support?",
      a: "Yes, from application to arrival — full assistance is provided.",
    },
  ];
