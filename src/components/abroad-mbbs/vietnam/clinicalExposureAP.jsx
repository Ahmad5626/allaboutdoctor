    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Real-time clinical exposure is provided across: {cities.join(", ")}
        </p>
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Internships include full departmental rotations under senior medical professionals.
        </p>
...
export default ClinicalExposureVietnam;
