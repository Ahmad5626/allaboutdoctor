...
export default function SerbiaHero() {
  return (
...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Serbia is an excellent opportunity for Indian
              medical aspirants aiming for a European-standard medical degree,
              globally recognized curriculum, and strong clinical exposure.
              Serbia’s medical universities offer modern infrastructure,
              experienced faculty, and English-medium MBBS programs aligned with
              international medical guidelines.
              <br /><br />
              With comprehensive overseas support, All About Doctor Education Pvt
              Ltd provides complete guidance to help students secure admission in
              Serbia’s top medical education hubs.
            </h2>
          </div>
        </div>
