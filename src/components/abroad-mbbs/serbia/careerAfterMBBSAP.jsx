...
const CareerAfterMBBSSerbia = () => {
  const careers = [
    {
      icon: <GraduationCap className="w-8 h-8 text-primary" />,
      title: "PG/MD/MS in India or other countries",
    },
    {
      icon: <BookOpenCheck className="w-8 h-8 text-primary" />,
      title: "NExT exam preparation for Indian licensing",
    },
    {
    ...
    },
    {
      ...
      title: "Academic teaching & research roles",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Serbia</span>
        </h1>
...
export default CareerAfterMBBSSerbia;
