...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Kazakhstan is a popular choice among Indian
              medical aspirants due to its affordable fee structure, globally
              accepted medical degrees, and modern university infrastructure.
              Kazakhstan offers English-medium MBBS programs, well-equipped
              teaching hospitals, and a safe learning atmosphere for
              international students.
              <br /><br />
              With end-to-end overseas support, All About Doctor Education Pvt
              Ltd assists students in securing admission across Kazakhstan’s
              leading MBBS destinations with complete transparency.
            </h2>
          </div>
        </div>
