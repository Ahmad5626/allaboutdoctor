...
const CareerAfterMBBSBulgaria = () => {
  const careers = [
    ...
    },
    {
      ...
      title: "Preparation for NExT (India)",
    },
    {
      icon: <Globe className="w-8 h-8 text-primary" />,
      title: "USMLE, PLAB, AMC, DHA, HAAD licensing exams",
    },
    {
      icon: <Stethoscope className="w-8 h-8 text-primary" />,
      title: "Clinical roles in hospitals & healthcare organizations",
    },
    {
      icon: <Microscope className="w-8 h-8 text-primary" />,
      title: "Medical teaching and research careers",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Bulgaria</span>
        </h1>
...
export default CareerAfterMBBSBulgaria;
