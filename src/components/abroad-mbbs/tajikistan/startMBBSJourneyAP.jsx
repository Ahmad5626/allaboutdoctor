...
const StartMBBSJourneyTajikistan = () => {
  const points = [
    "Free Counseling",
    "NEET Score–Based University Selection",
    "Documentation, Visa & Admission Assistance",
    "Travel, Hostel & On-Campus Support",
  ];
  ...
  return (
    <section className="px-4 md:px-8 py-16 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        >
          Start Your MBBS Journey in <span className="text-primary">Tajikistan</span>
        </h1>

        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-10">
          Begin your medical career with trusted guidance from All About Doctor Education Pvt Ltd.
        </p>
        ...
        <button className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 transition shadow-md">
          Request Your Free MBBS Abroad Plan Today!
...
export default StartMBBSJourneyTajikistan;
