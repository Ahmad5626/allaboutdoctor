...
const FaqTajikistan = () => {
  ...
  const faqs = [
    {
      q: "Is Tajikistan good for MBBS?",
      a: "Yes, it offers affordable, NMC-recognized, English-medium MBBS programs suitable for Indian students.",
    },
    {
      q: "Is NEET mandatory for MBBS in Tajikistan?",
      a: "Yes, NEET qualification is compulsory.",
    },
    {
      q: "Which regions are best for MBBS in Tajikistan?",
      a: "Dushanbe, Khujand, and Dangara are the primary MBBS hubs.",
    },
    {
      q: "Is a Tajikistan MBBS degree valid in India?",
      a: "Yes, after clearing NExT as per NMC guidelines.",
    },
    {
      q: "Does All About Doctor provide full Tajikistan MBBS assistance?",
      a: "Yes, including admission, documentation, visa, travel, and arrival support.",
    },
  ];
