...
export default function RomaniaHero() {
  return (
...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl">
              Pursuing MBBS in Romania is an excellent pathway for Indian medical
              aspirants looking for European-standard medical education, globally
              recognized degrees, and advanced clinical training. Romania’s medical
              universities are among the oldest in Europe, offering strong academic
              excellence, modern infrastructure, experienced faculty, and
              English-medium MBBS programs suitable for international students.
              <br /><br />
              With complete overseas assistance, All About Doctor Education Pvt Ltd
              ensures smooth and reliable admission support across Romania’s leading
