...
export default function UzbekistanHero() {
  return (
...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Uzbekistan is an excellent choice for Indian
              medical aspirants who want globally accepted medical education,
              affordable tuition structure, and strong clinical exposure.
              Uzbekistan’s medical universities follow modern academic standards,
              offer English-medium instruction, and provide a highly supportive
              atmosphere for international students.
              <br /><br />
              With dedicated overseas admission support, All About Doctor
              Education Pvt Ltd ensures a smooth and transparent admission
              process across the top MBBS hubs of Uzbekistan.
            </h2>
          </div>
        </div>
