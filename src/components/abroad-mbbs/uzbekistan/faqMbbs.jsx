...
const FaqUzbekistan = () => {
  ...
  const faqs = [
    {
      q: "Is Uzbekistan good for MBBS?",
      a: "Yes, it provides affordable, NMC-approved MBBS programs with strong clinical exposure.",
    },
    {
      q: "Is NEET required for MBBS in Uzbekistan?",
      a: "Yes, NEET qualification is mandatory for Indian students.",
    },
    {
      q: "Which regions are best for MBBS in Uzbekistan?",
      a: "Samarkand, Tashkent, Fergana, Bukhara, Andijan, Namangan, Nukus, Navoi.",
    },
    {
      q: "Is an Uzbekistan MBBS degree valid in India?",
      a: "Yes, after clearing NExT as required by NMC.",
    },
    {
      q: "Does All About Doctor provide complete support for Uzbekistan MBBS?",
      a: "Yes, including admission, documentation, visa processing, travel, and on-campus support.",
    },
  ];
