    ...
    <section className="px-4 md:px-8 py-16 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-6">
          Looking for more MBBS options across other countries?
          <br />
          Explore the complete MBBS Abroad guide for country-wise universities, fees, admission process, and visa support.
        </p>
