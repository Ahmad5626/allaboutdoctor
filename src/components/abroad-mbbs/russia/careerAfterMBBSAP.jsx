...
const CareerAfterMBBSRussia = () => {
  const careers = [
    {
      icon: <GraduationCap className="w-8 h-8 text-primary" />,
      title: "MD/MS or PG specializations in India or abroad",
    },
    {
    ...
    },
    {
      ...
      title: "Clinical practice in government or private hospitals",
    },
    {
...
export default CareerAfterMBBSRussia;
