...
export default function NepalHero() {
  return (
...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Nepal is an excellent choice for Indian medical
              aspirants who want NMC-recognized medical education, familiar
              culture, affordable fees, and strong clinical exposure. Nepal’s
              medical colleges follow a structured curriculum, modern teaching standards,
              and provide a comfortable learning environment for international
              students—especially those from India.
              <br /><br />
              With complete overseas guidance, All About Doctor Education Pvt Ltd
              ensures smooth admission support across Nepal’s leading MBBS destinations.
            </h2>
          </div>
        </div>
