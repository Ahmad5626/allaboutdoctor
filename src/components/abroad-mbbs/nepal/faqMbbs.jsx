...
const FaqNepal = () => {
  ...
  const faqs = [
    {
      q: "Is Nepal a good destination for MBBS?",
      a: "Yes, Nepal offers a reliable, NMC-approved, and culturally familiar environment for Indian MBBS students.",
    },
    {
    ...
    {
      q: "Which regions are best for MBBS in Nepal?",
      a: "Kathmandu, Pokhara, Biratnagar, Bharatpur, and Nepalgunj are top MBBS hubs.",
    },
    {
      q: "Is a Nepal MBBS degree valid in India?",
      a: "Yes, after clearing NExT as per NMC rules.",
    },
    {
      q: "Does All About Doctor provide full MBBS Nepal support?",
      a: "Yes, from admission to arrival with complete documentation assistance.",
    },
  ];
