...
const MbbsAdmissionProcessGeorgia = () => {
  const steps = [
    {
    ...
    },
    {
      ...
      details: [
        "Academic assessment and eligibility confirmation.",
      ],
    },
    {
      title: "3. Offer Letter Issuance",
      details: [
        "Quick admission confirmation from selected universities.",
      ],
    },
    {
      title: "4. Tuition Fee Guidance & Seat Confirmation",
      details: [
        "Transparent guidance on fee structure and payments.",
      ],
    },
    {
      title: "5. Visa Assistance",
      details: [
        "Complete support for visa documentation, interviews, and appointments.",
      ],
    },
    {
      title: "6. Pre-Departure Support",
      details: [
        "Travel planning, accommodation selection, packing guidance, and briefing.",
      ],
    },
    {
      title: "7. On-Arrival Assistance",
      details: [
        "Airport reception, hostel arrangement, and university orientation.",
      ],
    },
  ];
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Georgia</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd ensures a smooth and reliable admission journey for every student.
        </p>
...
export default MbbsAdmissionProcessGeorgia;
