...
const CareerAfterMBBSGeorgia = () => {
  const careers = [
    ...
    },
    {
      ...
      title: "Academic teaching & research careers",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Georgia</span>
        </h1>
...
export default CareerAfterMBBSGeorgia;
