export default function Documents() {
  const documents = [
    ...
    "Admission Offer Letter (issued later)",
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        <div className="grid md:grid-cols-2 gap-4 py-6">
          {documents.map((doc, idx) => (
            <div
              key={idx}
              className="border border-border rounded-lg p-4 flex items-start space-x-3"
            >
        ...
        <div className="border-l-4 border-primary pl-6 py-4 space-y-2">
          <p className="text-foreground leading-relaxed">
            All About Doctor provides full assistance in preparing and verifying documents for MBBS admission abroad.
          </p>
        </div>
      </div>
    </section>
