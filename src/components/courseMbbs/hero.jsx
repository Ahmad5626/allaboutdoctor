    ...
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        <h1
            ...
            >
         MBBS – Bachelor of Medicine,<span className="text-primary">Bachelor of Surgery</span> 

            </h1>
             <p className="text-lg md:text-xl text-primary font-semibold">
          Start your medical journey with All About Doctor Education Pvt. Ltd.
          </p>

         
        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
         India’s trusted medical education consultancy helping aspiring doctors build successful careers in medicine and surgery.
        </p>
