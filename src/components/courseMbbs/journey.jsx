  ...
  return (
    <div>
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
       ...
       Your dream of becoming a doctor begins here. All About Doctor Education Pvt. Ltd. has guided over 10,000+
            students toward successful MBBS admissions in India and abroad.
          </p>
