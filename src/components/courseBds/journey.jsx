      ...
      <section className="py-16 md:py-24 px-4 md:px-8 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-balance">
            Start Your <span className="text-secondary">BDS Journey</span> Today
          </h2>
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Your dream of becoming a Dental Surgeon begins with All About Doctor Education Pvt. Ltd.
            Join thousands of students who have successfully built their dental careers with our expert
            guidance and transparent admission process.
          </p>
