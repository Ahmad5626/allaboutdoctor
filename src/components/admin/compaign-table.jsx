...
export function CompaignTable() {
  ...
  const filteredCompaign = Compaign.filter(
    (user) =>
  ...
  return (
    <Card className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-semibold text-foreground">Compaign</h2>
          <p className="text-sm text-muted-foreground">Manage all Compaign and their permissions</p>
        </div>
      ...
      <div className="flex items-center justify-between mt-6">
        <p className="text-sm text-muted-foreground">Showing 1-5 of 1,234 Compaign</p>
