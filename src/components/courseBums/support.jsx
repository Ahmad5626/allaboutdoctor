...
const Support = () => {
  const supportSteps = [
    ...
    "NEET & AYUSH Counselling Assistance",
    "Application & Documentation Support",
    "Visa & Travel Guidance (for Abroad Programs)",
    "Hostel & Post-Enrolment Assistance",
  ]
      ...
      <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
        <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
          ...
          <p className="text-lg text-foreground/80 mb-8">
            At All About Doctor Education Pvt. Ltd., we guide students from start to finish — ensuring a seamless admission journey through:
          </p>
