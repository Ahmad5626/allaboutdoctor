  ...
  return (
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        >
          BUMS – <span className="text-primary">Bachelor of Unani Medicine and Surgery</span>
        </h1>

        <p className="text-lg md:text-xl text-primary font-semibold">
          Begin your journey in holistic healing and traditional medicine with All About Doctor Education Pvt. Ltd.
        </p>

        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
          We help students secure admissions in BUMS (Bachelor of Unani Medicine and Surgery) programs 
          offered by top AYUSH-recognised universities in India and abroad — empowering future practitioners 
          of Unani medicine to build successful, ethical, and science-backed careers.
        </p>
