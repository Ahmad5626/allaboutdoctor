  ...
  const criteria = [
    {
      ...
      text: "Must hold an MBBS degree from a recognized university.",
    },
    {
      icon: <ClipboardCheck className="w-8 h-8 text-primary" />,
      text: "Completion of a one-year internship is compulsory.",
    },
    {
    ...
    },
    {
      ...
      text: "Must qualify the NEET-PG or equivalent postgraduate entrance examination.",
    },
  ];
