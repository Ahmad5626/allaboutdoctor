import { Stethoscope, Microscope, Building2, GraduationCap, Sparkles, Scissors } from "lucide-react";
...
const Career = () => {
  const careerOptions = [
    ...
    },
    {
      ...
      title: "Clinical Researcher or Academician",
    },
    {
      icon: <Sparkles className="w-8 h-8 text-primary" />,
      title: "Laser and Aesthetic Medicine Specialist",
    },
    {
      icon: <Scissors className="w-8 h-8 text-primary" />,
      title: "Trichologist or Skin Surgeon",
    },
    {
      icon: <Building2 className="w-8 h-8 text-primary" />,
      title: "Private Clinic Owner or Medical Spa Consultant",
    },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10">
          ...
          >
            ...
            <span className="text-primary">MS in Dermatology</span>
          </h1>
