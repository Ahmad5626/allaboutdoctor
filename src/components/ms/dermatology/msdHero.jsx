      ...
      <header className="relative overflow-hidden border-b border-border">
        <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
          ...
          <p className="text-lg md:text-xl text-primary font-semibold">
            ...
            mentorship for pursuing an MS in Dermatology, a postgraduate medical
            program specializing in the diagnosis, treatment, and surgical
            management of skin, hair, and nail disorders.
          </p>

          <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
            This program focuses on both clinical dermatology and advanced
            cosmetic and reconstructive procedures — preparing medical graduates
            to become expert dermatologists with strong practical, diagnostic,
            and research-oriented skills.
            <br />
            Our dedicated team supports you at every step, from NEET-PG
            preparation to university shortlisting, admission guidance, and
