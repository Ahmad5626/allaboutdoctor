...
const Journey = () => {
  return (
   ...
   Ready to master the art of medical imaging and diagnostics with an MS in Radiology?
 Let All About Doctor Education Pvt. Ltd. guide you through every step — from counseling to successful admission — with expert-led, end-to-end support.
          </p>
