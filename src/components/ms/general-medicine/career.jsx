import { UserCheck, GraduationCap, Building2, Stethoscope, Microscope } from "lucide-react";
  ...
  const careerOptions = [
    {
      ...
      title: "Consultant Surgeon or Surgical Specialist",
    },
    {
      icon: <GraduationCap className="w-8 h-8 text-primary" />,
      title: "Academic Faculty or Surgical Researcher",
    },
    {
      icon: <Building2 className="w-8 h-8 text-primary" />,
      title: "Hospital Administrator or Clinical Director",
    },
    {
      icon: <UserCheck className="w-8 h-8 text-primary" />,
      title: "Specialist in Advanced Surgical Fellowships",
    },
    {
      icon: <Microscope className="w-8 h-8 text-primary" />,
      title: "Independent or Private Practitioner",
    },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10">
          ...
          >
            ...
            <span className="text-primary">MS in General Medicine</span>
          </h1>
