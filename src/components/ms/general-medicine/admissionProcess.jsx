...
const AdmissionProcess = () => {
  const steps = [
    ...
    "Qualify for NEET-PG or other recognized entrance exams.",
    "Participate in the centralized counseling process.",
    "Get expert university shortlisting and personalized guidance from All About Doctor Education Pvt. Ltd.",
    "Complete documentation and begin your MS journey.",
  ];
