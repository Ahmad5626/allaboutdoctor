      ...
      <header className="relative overflow-hidden border-b border-border">
        <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
          ...
          <p className="text-lg md:text-xl text-primary font-semibold">
            All About Doctor Education Pvt. Ltd. offers comprehensive guidance
            and admission support for students aspiring to pursue an MS in
            Pathology, a postgraduate program that focuses on the study of
            diseases through clinical, microscopic, and laboratory investigation.
          </p>

          <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
            This program equips doctors with the expertise to analyze tissue
            samples, diagnose complex diseases, and contribute to medical
            research and innovation.
            <br />
            With expert mentorship, NEET-PG preparation assistance, and admission
            counseling, we help you take the next step toward becoming a skilled
            pathologist.
          </p>
