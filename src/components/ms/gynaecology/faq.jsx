...
const Faq = () => {
  ...
  const faqs = [
    {
      q: "What is the duration of MS Gynaecology?",
    ...
    },
    {
      ...
      a: "Yes, All About Doctor Education Pvt. Ltd. assists students in pursuing MS-equivalent programs in reputed international universities with globally recognized degrees.",
    },
    {
      q: "What is the career scope after MS in Gynaecology?",
      a: "Graduates can work as obstetricians, fertility experts, laparoscopic surgeons, or medical faculty in hospitals and universities.",
    },
  ];
