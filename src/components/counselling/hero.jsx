    ...
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        <h1
            ...
            >
           Counselling Services <span className="text-primary">About All About Doctor Education Pvt Ltd</span> 
        ...
        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
          At All About Doctor Education Pvt Ltd, our counselling services are designed to guide aspiring Indian doctors through every step of their journey to study medicine abroad. We provide expert advice, personalized career planning, and step-by-step support to help students make informed decisions and achieve their dreams.
        </p>
