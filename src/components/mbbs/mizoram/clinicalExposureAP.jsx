    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Students receive strong clinical exposure through structured training in:
        </p>
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Internships include mandatory rotations across all major departments under the supervision of qualified medical professionals.
        </p>
...
export default ClinicalExposureMizoram;
