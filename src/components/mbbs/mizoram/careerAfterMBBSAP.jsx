...
const CareerAfterMBBSMizoram = () => {
  const careers = [
    ...
    {
      icon: <GraduationCap className="w-8 h-8 text-primary" />,
      title: "Research, teaching, and medical academia",
    },
    {
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Mizoram</span>
        </h1>
...
export default CareerAfterMBBSMizoram;
