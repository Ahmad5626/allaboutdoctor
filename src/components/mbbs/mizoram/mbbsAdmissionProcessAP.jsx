...
const MbbsAdmissionProcessMizoram = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Support for online form submission, document upload, and verification.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Expert guidance to match college options with rank, budget, and preferences.",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Real-time tracking until final allotment.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "On-ground and remote guidance for document verification, fee payment, and joining procedures.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Mizoram</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd guides students through every stage of the admission cycle.
        </p>
...
export default MbbsAdmissionProcessMizoram;
