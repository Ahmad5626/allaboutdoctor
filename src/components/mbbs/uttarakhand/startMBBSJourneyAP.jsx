...
const StartMBBSJourneyUttarakhand = () => {
  const points = [
    "Free Counseling",
    "Personalized College Mapping",
    "State-Wise Admission Support",
    ...
    <section className="px-4 md:px-8 py-16 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-10">
          Begin your medical education journey with expert support from All About Doctor Education Pvt Ltd.
        </p>
...
export default StartMBBSJourneyUttarakhand;
