...
const CareerAfterMBBSUttarakhand = () => {
  const careers = [
    {
    ...
    },
    {
      ...
      title: "Medical teaching & research roles",
    },
    {
      icon: <Globe className="w-8 h-8 text-primary" />,
      title: "International pathways (USMLE, PLAB, AMC, DHA, HAAD)",
    },
    {
      icon: <Stethoscope className="w-8 h-8 text-primary" />,
      title: "Clinical practice in public and private sectors",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Uttarakhand</span>
        </h1>
...
export default CareerAfterMBBSUttarakhand;
