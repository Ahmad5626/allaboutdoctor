...
const MbbsAdmissionProcessPunjab = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Guidance for online registration and document upload on the official state counseling portal.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Personalized college shortlisting across major medical cities including: Amritsar, Ludhiana, Jalandhar, Patiala, Mohali, Bathinda, Faridkot, Fatehgarh Sahib.",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Tracking all counseling rounds until final seat allotment.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Support for physical reporting, verification, fee payment, and joining procedures.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Punjab</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd supports students through each stage of their admission process.
        </p>
...
export default MbbsAdmissionProcessPunjab;
