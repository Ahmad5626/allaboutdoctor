...
const MbbsEligibilityPunjab = () => {
  const eligibility = [
    "Qualify NEET-UG",
    "Complete 10+2 with Physics, Chemistry & Biology",
    "Register for Punjab NEET-UG counseling",
    "Submit required academic & identity documents",
    "Fulfill domicile requirements (for state quota seats)",
  ];
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-white">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        >
          Eligibility for <span className="text-primary">MBBS in Punjab</span>
        </h2>
...
export default MbbsEligibilityPunjab;
