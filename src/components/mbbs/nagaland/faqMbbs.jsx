...
const FaqNagaland = () => {
  ...
  const faqs = [
    {
      q: "Is NEET-UG mandatory for MBBS in Nagaland?",
      a: "Yes, qualifying NEET-UG is compulsory.",
    },
    {
      q: "Which is the main city for MBBS in Nagaland?",
      a: "Kohima is the major medical education hub.",
    },
    {
      q: "Are MBBS fees affordable in Nagaland?",
      a: "Government institutions offer budget-friendly fees.",
    },
    {
      q: "Is clinical exposure good in Nagaland?",
      a: "Students receive structured training with improving patient flow.",
    },
    {
      q: "Does All About Doctor provide counseling support?",
      a: "Yes, complete NEET-based guidance is offered from registration to admission.",
    },
  ];
