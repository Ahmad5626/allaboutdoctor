  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12 md:py-14">
        ...
        >
          Top Cities for MBBS in <span className="text-primary">Nagaland</span>
        </h1>

        <p className="text-muted-foreground text-lg mb-8 max-w-3xl">
          Kohima
          <br /><br />
          The capital city provides organized medical training, developing hospital
          infrastructure, and a growing clinical environment for practical learning.
        </p>
...
export default TopCityNagaland;
