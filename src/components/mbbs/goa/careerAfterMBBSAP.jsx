...
const CareerAfterMBBSGoa = () => {
  const careers = [
    {
      icon: <GraduationCap className="w-8 h-8 text-primary" />,
      title: "MD/MS Postgraduate Programs",
    },
    {
    ...
    },
    {
      ...
      title: "Research, academic roles & public health pathways",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Goa</span>
        </h1>
...
export default CareerAfterMBBSGoa;
