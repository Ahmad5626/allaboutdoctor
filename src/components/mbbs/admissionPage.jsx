...
export default function AdmissionPage() {
  return (
    <div className=" bg-gray-50 flex items-center justify-center p-2 my-5">
      <div className="max-w-7xl w-full bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/assets/img/bg6.png')" }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-center">
            <div className="w-full max-w-md bg-gradient-to-br from-primary via-white to-white rounded-4xl p-8 shadow-2xl">
              {/* Header */}
              <div className="mb-4">
                <h1 className="text-4xl font-bold text-secondary mb-1 leading-tight">Secure Admission</h1>
                <p className="text-xl text-orange-400 font-medium">in Top NMC-Approved Colleges</p>
              </div>
              ...
              <div className="space-y-5 mb-8">
                ...
                <div className="bg-secondary border-3 border-orange-600 rounded-2xl p-5 flex items-center gap-4">
                  ...
                  <span className="text-slate-800 font-medium text-lg">College Recommendations</span>
                </div>

                {/* Admission Guidance */}
                <div className="bg-secondary border-3 border-orange-600 rounded-2xl p-5 flex items-center gap-4">
                  <CheckCircle2 className="w-7 h-7 text-blue-500 flex-shrink-0" />
                  <span className="text-slate-800 font-medium text-lg">Admission Guidance</span>
                </div>

                {/* Documentation Support */}
                <div className="bg-secondary border-3 border-orange-600 rounded-2xl p-5 flex items-center gap-4">
                  <FileText className="w-7 h-7 text-slate-800 flex-shrink-0" />
                  <span className="text-slate-800 font-medium text-lg">Documentation Support</span>
                </div>
              </div>
          ...
          {/* Right Image Section */}
          <div className="flex justify-center lg:justify-start bg-cover bg-center bg-no-repeat" >
            <div className="relative w-full max-w-2xl">
              <img
                src="/assets/img/erasebg-transformed.png"
                alt="Healthcare professionals in front of building"
                className="md:w-[570px] h-auto object-contain"
              />
            </div>
          </div>
        </div>
