...
const CareerAfterMBBSHaryana = () => {
  const careers = [
    ...
    },
    {
      ...
      title: "Government medical officer posts",
    },
    {
    ...
    },
    {
      ...
      title: "Global licensing exams: USMLE, PLAB, AMC, DHA, HAAD",
    },
    {
      icon: <Microscope className="w-8 h-8 text-primary" />,
      title: "Research and academic careers",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Haryana</span>
        </h1>
...
export default CareerAfterMBBSHaryana;
