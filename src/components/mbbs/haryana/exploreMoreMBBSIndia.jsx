    ...
    <section className="px-4 md:px-8 py-16 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-6">
          Want options in other states? <br />
          Access the full MBBS in India guide with state-wise colleges, fees,
          admission process, and counseling help.
        </p>

        <a
          href="/mbbs-in-india"   // folder link unchanged but confirmed
