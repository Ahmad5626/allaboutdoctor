...
export default function StartMBBSJourneyLucknow() {
  const points = [
    "Free Counseling",
    "NEET Score–Based College Mapping",
    "Lucknow & UP City-Wise Options",
  ...
  return (
    <section className="px-4 md:px-8 py-16 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        <h1 className="text-4xl sm:text-4xl font-semibold animate-fade-up mb-6" style={{ animationDelay: "100ms" }}>
          Start Your MBBS Journey in <span className="text-primary">Lucknow</span>
        </h1>
        ...
        <button className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition shadow-md">
