...
// Eligibility Section
export default   function MbbsEligibilityLucknow() {
  const eligibility = [
    "Qualify NEET-UG",
    "10+2 with PCB subjects",
    "Participation in UP NEET-UG counseling",
    "Submission of required academic documents",
    "State domicile rules for state quota seats",
  ]
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-white">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        >
          Eligibility for <span className="text-primary">MBBS in Lucknow</span>
        </h2>
