...
// Admission Process Section
 export default  function MbbsAdmissionProcessLucknow() {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: ["Support for UP NEET registration and document submission."],
    },
    {
      title: "2. College Shortlisting",
      details: ["Personalized list based on NEET score, affordability, and preferred location."],
    },
    {
      title: "3. Choice Filling Assistance",
      details: ["Guidance based on faculty", "Hospital quality", "Campus facilities", "Previous cutoff trends"],
    },
    {
      title: "4. Seat Allotment Tracking",
      details: ["Monitoring each round of UP NEET counseling."],
    },
    {
      title: "5. Admission & Reporting",
      details: ["Help with verification, paperwork, and fee submission."],
    },
    {
      title: "6. Post-Admission Support",
      details: ["Hostel assistance", "Travel guidance", "Study planning", "Academic orientation"],
    },
  ]
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Lucknow</span>
        </h1>
        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt. Ltd. provides complete admission guidance.
        </p>
