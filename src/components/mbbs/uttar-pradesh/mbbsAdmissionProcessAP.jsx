...
const MbbsAdmissionProcessUttarPradesh = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Support for online registration and document upload on the official counseling portal.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Score",
      details: [
        "Personalized shortlisting of medical colleges across top cities based on NEET rank.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Uttar Pradesh</span>
        </h1>
...
export default MbbsAdmissionProcessUttarPradesh;
