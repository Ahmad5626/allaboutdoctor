...
export default function StartMBBSJourneySitapur() {
  const points = [
    "Free Counseling",
    "NEET Score–Based College Mapping",
    "Sitapur & UP City-Wise Options",
  ...
  return (
    <section className="px-4 md:px-8 py-16 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        <h2 className="text-4xl sm:text-4xl font-semibold animate-fade-up mb-6" style={{ animationDelay: "100ms" }}>
          Start Your MBBS Journey in <span className="text-primary">Sitapur</span>
        </h2>
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-10">
          Begin your medical career with expert support from All About Doctor Education Pvt. Ltd.
        </p>
