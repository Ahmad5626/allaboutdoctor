import { GraduationCap, Globe, Building2, Microscope, Stethoscope } from "lucide-react"

export default function CareerAfterMBBSSitapur() {
  const careers = [
    {
    ...
    },
    {
      ...
      title: "Clinical practice and medical entrepreneurship",
    },
  ]
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          Career Opportunities After <span className="text-primary">MBBS in Sitapur</span>
        </h2>
