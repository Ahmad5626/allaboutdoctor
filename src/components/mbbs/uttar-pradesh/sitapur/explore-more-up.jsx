...
export default function ExploreMoreUP() {
  return (
    <section className="px-4 md:px-8 py-16 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        <h2 className="text-4xl font-semibold text-foreground mb-4">
          Explore More – <span className="text-primary">MBBS in Uttar Pradesh</span>
        </h2>
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-6">
          Each city provides recognized medical colleges, strong clinical exposure, and structured MBBS programs.
        </p>
        <a
