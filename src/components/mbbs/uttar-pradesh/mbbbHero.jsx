...
export default function UttarPradeshHero() {
  return (
...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Uttar Pradesh is a valuable opportunity for medical
              aspirants seeking quality education, extensive clinical exposure,
              and access to a wide network of NMC-recognized medical colleges.
              Uttar Pradesh hosts government, private, and deemed medical colleges
              equipped with modern laboratories, multi-specialty hospitals,
              experienced faculty, and structured academic systems designed for
              ...
              MBBS seats across top medical hubs in Uttar Pradesh.
            </h2>
          </div>
        </div>
