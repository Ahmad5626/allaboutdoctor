...
const FaqKashmir = () => {
  ...
  const faqs = [
    {
      q: "How many MBBS seats are available in Kashmir?",
      a: "Seats are distributed across government and private medical colleges under JKBOPEE counseling.",
    },
    {
      q: "Is NEET mandatory for MBBS admission in Kashmir?",
      a: "Yes, NEET-UG qualification is required for all MBBS seats.",
    },
    {
      q: "Which cities are best for MBBS in Kashmir?",
      a: "Jammu, Srinagar, Anantnag, Baramulla, Kathua, Udhampur, Rajouri, Doda, and Handwara (Kupwara).",
    },
    {
      q: "Do private colleges in Kashmir offer good clinical exposure?",
