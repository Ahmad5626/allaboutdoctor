...
const WhyChooseKashmir = () => {
  const points = [
    ...
    "Kashmir is known for its disciplined academic structure, safe environment, and high-quality medical teaching standards.",
  ];
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-12 md:py-14">
        ...
        >
          Why Choose <span className="text-primary">Kashmir</span> for MBBS?
        </h1>
...
export default WhyChooseKashmir;
