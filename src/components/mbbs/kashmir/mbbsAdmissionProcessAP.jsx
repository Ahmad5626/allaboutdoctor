...
const MbbsAdmissionProcessKashmir = () => {
  const steps = [
    {
      title: "1. Counselling Registration",
      details: [
        "Support for online form filling and document verification.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Personalized guidance across: Jammu, Srinagar, Anantnag, Baramulla, Doda, Kathua, Rajouri, Udhampur, Handwara (Kupwara).",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Real-time tracking until final allotment is issued.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Assistance with joining formalities, documentation, and campus-based requirements.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Kashmir</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd assists students at every step of the admission journey.
        </p>
...
export default MbbsAdmissionProcessKashmir;
