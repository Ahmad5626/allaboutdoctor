...
const MbbsDurationStructureKashmir = () => {
  const points = [
    ...
    "Internship: Structured department-wise rotations across Kashmir’s major hospitals.",
  ];
    ...
    <section className="px-4 md:px-8 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="mt-4 text-muted-foreground text-lg max-w-3xl">
          The MBBS curriculum in Kashmir follows the NMC academic framework:
        </p>
...
export default MbbsDurationStructureKashmir;
