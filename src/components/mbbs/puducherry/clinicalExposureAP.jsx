...
const ClinicalExposurePuducherry = () => {
  const departments = [
    "General Medicine",
    "General Surgery",
    "Pediatrics",
    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Top hospitals in Puducherry and Karaikal provide extensive internship experience in:
        </p>
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Students gain practical exposure through OPD, IPD, emergency, and specialty ward postings under expert guidance.
        </p>
...
export default ClinicalExposurePuducherry;
