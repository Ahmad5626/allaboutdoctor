...
const MbbsEligibilityJharkhand = () => {
  const eligibility = [
    "Qualify NEET-UG",
    "Complete 10+2 with Physics, Chemistry & Biology",
    "Participate in counseling under JCECEB (Jharkhand Combined Entrance Competitive Examination Board)",
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-white">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        >
          Eligibility for <span className="text-primary">MBBS in Jharkhand</span>
        </h2>
...
export default MbbsEligibilityJharkhand;
