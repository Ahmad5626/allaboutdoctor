...
const FaqJharkhand = () => {
  ...
  const faqs = [
    {
      q: "How many MBBS seats are available in Jharkhand?",
      a: "Seats are distributed across government and private medical colleges under JCECEB counseling.",
    },
    {
      q: "Is NEET mandatory for MBBS admission in Jharkhand?",
      a: "Yes, NEET-UG qualification is required for all MBBS seats.",
    },
    {
      q: "Which cities are best for MBBS in Jharkhand?",
      a: "Ranchi, Jamshedpur, Dhanbad, Hazaribagh, Palamu, Deoghar, and Dumka.",
    },
    {
      q: "Do private colleges in Jharkhand offer good clinical exposure?",
      a: "Yes, private medical colleges maintain strong hospital linkages and hands-on training environments.",
    },
    {
