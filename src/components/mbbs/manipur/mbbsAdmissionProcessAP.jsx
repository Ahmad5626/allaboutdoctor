...
const MbbsAdmissionProcessManipur = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Guidance for online registration, document upload, and form completion.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Personalized selection support across: Imphal, Churachandpur",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Real-time tracking of seat allocation until final allotment.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Assistance with physical reporting, verification, fee payment, and joining formalities.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Manipur</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd supports students at every stage of the admission process.
        </p>
...
export default MbbsAdmissionProcessManipur;
