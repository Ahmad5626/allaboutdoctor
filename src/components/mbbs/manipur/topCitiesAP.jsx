...
const TopCityManipur = () => {
  const cities = ["Imphal", "Churachandpur"];
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12 md:py-14">
        ...
        >
          Top Cities for MBBS in <span className="text-primary">Manipur</span>
        </h1>

        <p className="text-muted-foreground text-lg mb-8 max-w-3xl">
          Imphal, Churachandpur
          <br /><br />
          These cities provide advanced laboratories, digital classrooms,
          skill-based training, and hands-on hospital exposure for MBBS students.
        </p>
