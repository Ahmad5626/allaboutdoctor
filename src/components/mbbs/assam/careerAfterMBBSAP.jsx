import { Stethoscope, GraduationCap, Globe, Building2, BookOpenCheck, Microscope } from "lucide-react";
import React from "react";

const CareerAfterMBBSAP = () => {
  const careers = [
    {
    ...
    },
    {
      ...
      title: "NExT-based postgraduate pathways",
    },
    {
    ...
    },
    {
      ...
      title: "International licensing exams (USMLE, PLAB, DHA, HAAD, AMC)",
    },
    {
      icon: <Microscope className="w-8 h-8 text-primary" />,
      title: "Research & medical academics",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Assam</span>
        </h1>
...
export default CareerAfterMBBSAP;
