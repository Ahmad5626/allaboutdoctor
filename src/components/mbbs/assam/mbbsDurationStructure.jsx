...
const MbbsDurationStructureAssam = () => {
  const points = [
    ...
    "Learning Approach: Classroom teaching, clinical rotations, simulation labs, community postings.",
    "Internship: City-wise rotations across major departments in recognized hospitals."
  ];
    ...
    <section className="px-4 md:px-8 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="mt-4 text-muted-foreground text-lg max-w-3xl">
          The MBBS program in Assam follows the NMC curriculum:
        </p>
...
export default MbbsDurationStructureAssam;
