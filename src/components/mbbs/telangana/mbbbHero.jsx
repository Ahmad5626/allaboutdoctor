...
export default function TelanganaHero() {
  return (
...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Telangana is an excellent choice for medical 
              aspirants seeking advanced medical education, modern healthcare 
              systems, and strong clinical exposure. The state is home to several 
              NMC-recognized government and private medical colleges, known for 
              their robust infrastructure, high patient inflow, and experienced 
              medical faculty.
              <br /><br />
              With structured NEET-UG counseling, transparent seat allocation, and 
              expert admission support, All About Doctor Education Pvt Ltd helps 
              students secure MBBS seats across Telangana’s top medical regions 
              and cities.
            </h2>
          </div>
        </div>
