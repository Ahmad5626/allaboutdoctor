...
const MbbsAdmissionProcessTelangana = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Guidance for online registration and document submission on the official state counseling portal.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Personalized shortlisting across major medical regions including: Hyderabad, Warangal–Hanamkonda, Karimnagar, Nizamabad, Khammam, Nalgonda, Adilabad, Mahabubnagar, Medak–Sangareddy–Siddipet–Vikarabad.",
      ],
    },
    {
      ...
      details: [
        ...
        "Fees & hostel facilities",
        "Clinical exposure",
        "Cutoff trends",
        "Past ranking patterns",
      ],
    },
    {
      title: "4. Seat Allotment Tracking",
      details: [
        "Support for Round 1, Round 2, Mop-up, and stray vacancy rounds.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Guidance for physical reporting, document verification, and fee payment.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Telangana</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd offers end-to-end admission support across every stage.
        </p>
...
export default MbbsAdmissionProcessTelangana;
