...
const CareerAfterMBBSTelangana = () => {
  const careers = [
    {
      icon: <GraduationCap className="w-8 h-8 text-primary" />,
      title: "MD/MS & PG Diploma courses",
    },
    {
    ...
    },
    {
      ...
      title: "Resident doctor roles in govt & private hospitals",
    },
    {
    ...
    },
    {
      ...
      title: "Teaching & research positions",
    },
    {
      icon: <Globe className="w-8 h-8 text-primary" />,
      title: "International exams (USMLE, PLAB, AMC)",
    },
    {
      icon: <Building2 className="w-8 h-8 text-primary" />,
      title: "Hospital administration roles",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Telangana</span>
        </h1>
...
export default CareerAfterMBBSTelangana;
