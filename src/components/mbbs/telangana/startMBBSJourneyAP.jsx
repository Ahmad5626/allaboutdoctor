...
const StartMBBSJourneyTelangana = () => {
  const points = [
    "Free Counseling",
    "NEET Rank-Based College Mapping",
    "City-Wise College Selection",
    "Admission & Reporting Support",
  ];
  ...
  return (
    <section className="px-4 md:px-8 py-16 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        >
          Start Your MBBS Journey in <span className="text-primary">Telangana</span>
        </h1>

        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-10">
          Begin your medical career with expert guidance from All About Doctor Education Pvt Ltd.
        </p>
...
export default StartMBBSJourneyTelangana;
