...
const CareerAfterMBBSAP = () => {
  const careers = [
    ...
    },
    {
      ...
      title: "Private Hospital Clinical Practice",
    },
    {
      icon: <Globe className="w-8 h-8 text-primary" />,
      title: "International Medical Exams (USMLE, PLAB, AMC, DHA, HAAD)",
    },
    {
      icon: <Microscope className="w-8 h-8 text-primary" />,
      title: "Medical Research & Academia",
    },
  ];
    ...
    <section className="px-4 md:px-8  border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Andhra Pradesh</span>
        </h1>
