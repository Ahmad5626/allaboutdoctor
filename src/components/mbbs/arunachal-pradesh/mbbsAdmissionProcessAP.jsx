...
const MbbsAdmissionProcessArunachal = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Guidance for online registration and document verification.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Expert suggestions focused on the primary medical hub:",
        "Naharlagun",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Monitoring results until allotment confirmation.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Support for reporting at the institution.",
        "Assistance with documentation and joining formalities.",
      ],
    },
    {
    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd provides complete support through every stage of MBBS admission in Arunachal Pradesh.
        </p>
...
export default MbbsAdmissionProcessArunachal;
