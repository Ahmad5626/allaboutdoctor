  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        >
          Clinical Exposure &{" "}
          <span className="text-primary">Internship Training</span>
        </h1>

        <p className="text-muted-foreground text-lg max-w-3xl mb-6">
          Students in Naharlagun receive hands-on exposure in:
        </p>
        ...
        <p className="mt-6 text-foreground/80 text-lg">
          Internships include structured rotations under experienced clinical
          teams.
        </p>
      </div>
    </section>
