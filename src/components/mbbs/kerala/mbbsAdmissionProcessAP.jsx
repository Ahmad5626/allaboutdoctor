...
const MbbsAdmissionProcessKerala = () => {
  const steps = [
    {
      title: "1. Counselling Registration",
      details: [
        "Support with online registration, fee payment, and document verification.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Personalized guidance across: Thiruvananthapuram, Alappuzha, Kollam, Pathanamthitta, Kottayam, Ernakulam, Thrissur, Kozhikode, Malappuram, Wayanad, Palakkad, Idukki, Kannur, Kasaragod.",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Real-time updates and guidance until allotment is finalized.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Assistance with documentation, physical reporting, and college joining formalities.",
      ],
    },
    {
      title: "6. Post-Admission Support",
      details: [
        "Hostel arrangement assistance",
        "Travel guidance",
        "Orientation support",
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Kerala</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd guides students through every stage of the MBBS admission journey.
        </p>
...
export default MbbsAdmissionProcessKerala;
