...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Kerala is an excellent choice for medical aspirants 
              seeking high academic standards, strong clinical exposure, and a 
              disciplined learning environment. Kerala is home to several 
              NMC-approved medical colleges known for advanced medical infrastructure, 
              experienced faculty, and consistent patient flow, making it one of 
              India’s most preferred states for medical education.
              <br /><br />
              With expert support and transparent counseling guidance, 
              All About Doctor Education Pvt Ltd helps students secure MBBS 
              admissions across all major medical cities in Kerala.
            </h2>
          </div>
        </div>
