...
const FaqKerala = () => {
  ...
  const faqs = [
    {
      q: "How many MBBS seats are available in Kerala?",
      a: "Seats are available across government and private medical colleges under CEE Kerala counseling.",
    },
    {
      q: "Is NEET mandatory for MBBS admission in Kerala?",
      a: "Yes, NEET-UG qualification is compulsory.",
    },
    {
      q: "Which cities are best for MBBS in Kerala?",
      a: "Top choices include Thiruvananthapuram, Ernakulam, Kozhikode, Kottayam, Thrissur, and Kannur.",
    },
    {
      q: "Do private medical colleges in Kerala offer good clinical exposure?",
      a: "Yes, private colleges have strong hospital linkages and excellent training environments.",
    },
    {
