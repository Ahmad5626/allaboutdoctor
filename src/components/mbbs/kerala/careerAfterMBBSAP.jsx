...
const CareerAfterMBBSKerala = () => {
  const careers = [
    ...
    },
    {
      ...
      title: "Practice in private or corporate hospitals",
    },
    {
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Kerala</span>
        </h1>
...
export default CareerAfterMBBSKerala;
