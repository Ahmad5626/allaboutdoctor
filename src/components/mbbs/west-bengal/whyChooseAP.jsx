...
const WhyChooseWestBengal = () => {
  const points = [
    ...
    "West Bengal is ideal for students seeking a blend of high-quality academics and comprehensive practical training.",
  ];
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-12 md:py-14">
        ...
        >
          Why Choose <span className="text-primary">West Bengal</span> for MBBS?
        </h1>
...
export default WhyChooseWestBengal;
