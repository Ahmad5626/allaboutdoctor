...
const FaqWestBengal = () => {
  ...
  const faqs = [
    ...
    {
      q: "Is NEET-UG mandatory for MBBS in West Bengal?",
      a: "Yes, NEET qualification is compulsory.",
    },
    {
      q: "Which are the best cities for MBBS in West Bengal?",
      a: "Kolkata, Durgapur, Siliguri, Asansol, and Kalyani.",
    },
    {
      q: "Do private colleges in West Bengal offer good clinical exposure?",
