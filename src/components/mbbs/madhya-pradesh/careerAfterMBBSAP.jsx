...
const CareerAfterMBBSMadhyaPradesh = () => {
  const careers = [
    {
    ...
    },
    {
      ...
      title: "Government doctor positions",
    },
    {
    ...
    },
    {
      ...
      title: "Healthcare research, academics & public health roles",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Madhya Pradesh</span>
        </h1>
...
export default CareerAfterMBBSMadhyaPradesh;
