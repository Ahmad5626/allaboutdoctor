...
const CareerAfterMBBSTamilNadu = () => {
  const careers = [
    {
    ...
    },
    {
      ...
      title: "Teaching & academic medicine",
    },
    {
    ...
    {
      icon: <Microscope className="w-8 h-8 text-primary" />,
      title: "Research & public health careers",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Tamil Nadu</span>
        </h1>
...
export default CareerAfterMBBSTamilNadu;
