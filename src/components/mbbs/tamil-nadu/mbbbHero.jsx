...
export default function TamilNaduHero() {
  return (
...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Tamil Nadu is one of the best choices for medical
              aspirants who aim for high academic standards, exceptional clinical
              exposure, and advanced healthcare infrastructure. Tamil Nadu is home
              to India’s top NMC-recognized government and private medical colleges,
              known for their excellent patient flow, modern medical systems,
              research-driven environment, and skilled faculty.
              <br /><br />
              With structured NEET counseling support, college shortlisting, and 
              complete admission guidance, All About Doctor Education Pvt Ltd
              helps students secure MBBS admissions across all major medical hubs
              in Tamil Nadu.
            </h2>
          </div>
        </div>
