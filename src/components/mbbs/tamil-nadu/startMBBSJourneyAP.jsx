...
const StartMBBSJourneyTamilNadu = () => {
  const points = [
    "Free Counseling",
    "NEET Rank-Based College Mapping",
    "City-Wise Support (All Tamil Nadu Cities)",
  ...
  return (
    <section className="px-4 md:px-8 py-16 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        >
          Start Your MBBS Journey in <span className="text-primary">Tamil Nadu</span>
        </h1>

        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-10">
          Begin your medical career with trusted admission support from All About Doctor Education Pvt Ltd.
        </p>
...
export default StartMBBSJourneyTamilNadu;
