...
const MbbsAdmissionProcessHimachal = () => {
  const steps = [
    {
    ...
    },
    {
      ...
      details: [
        "Personalized guidance across Shimla, Kangra, Mandi, Hamirpur, Chamba, Nahan, Solan, Bilaspur.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Himachal Pradesh</span>
        </h1>
...
export default MbbsAdmissionProcessHimachal;
