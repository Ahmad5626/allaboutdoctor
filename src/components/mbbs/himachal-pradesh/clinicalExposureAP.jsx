...
const ClinicalExposureHimachal = () => {
  const cities = [
    "Shimla",
    "Kangra",
    "Mandi",
    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Cities such as Shimla, Kangra, Mandi, Hamirpur, Solan, Bilaspur, Nahan, and Chamba offer strong hospital exposure in:
        </p>
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Internship includes mandatory rotations across major medical departments under experienced doctors:
        </p>
...
export default ClinicalExposureHimachal;
