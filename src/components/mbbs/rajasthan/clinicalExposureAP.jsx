...
const ClinicalExposureRajasthan = () => {
  const departments = [
    "General Medicine",
    "Pediatrics",
    "General Surgery",
    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Rajasthan’s major medical hubs—especially {topCities.join(", ")}—offer robust clinical exposure in:
        </p>
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Interns gain hands-on experience in both routine and emergency care settings.
        </p>
...
export default ClinicalExposureRajasthan;
