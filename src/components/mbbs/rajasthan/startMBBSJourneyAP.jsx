...
const StartMBBSJourneyRajasthan = () => {
  const points = [
    "Free Counseling",
    "NEET Rank-Based College Mapping",
    "City-Wise Admission Guidance",
  ...
  return (
    <section className="px-4 md:px-8 py-16 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        >
          Start Your MBBS Journey in <span className="text-primary">Rajasthan</span>
        </h1>
...
export default StartMBBSJourneyRajasthan;
