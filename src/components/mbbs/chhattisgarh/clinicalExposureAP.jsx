...
const ClinicalExposureChhattisgarh = () => {
  const cities = [
    "Raipur",
    "Bilaspur",
    "Jagdalpur",
    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Cities like Raipur, Bilaspur, Jagdalpur, Raigarh, Durg, Bhilai, and others offer excellent hands-on exposure in:
        </p>
        ...
        <p className="mt-6 text-foreground/80 text-lg">
          Internships include departmental rotations guided by senior medical faculty and clinical specialists.
        </p>
      </div>
    </section>
  );
...
export default ClinicalExposureChhattisgarh;
