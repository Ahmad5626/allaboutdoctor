...
const CareerAfterMBBSMeghalaya = () => {
  const careers = [
    {
    ...
    },
    {
      ...
      title: "Government medical officer jobs",
    },
    {
      icon: <Stethoscope className="w-8 h-8 text-primary" />,
      title: "Private clinical practice",
    },
    {
    ...
    },
    {
      ...
      title: "Research, teaching, and public healthcare roles",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Meghalaya</span>
        </h1>
...
export default CareerAfterMBBSMeghalaya;
