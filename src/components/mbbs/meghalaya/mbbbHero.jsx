...
export default function MeghalayaHero() {
  return (
...
<span > Complete Admission Guidance</span>
          ...
          <div className="pt-0 space-y-4">
            <h2 className="mt-4 text-muted-foreground text-lg md:text-xl fade-item">
              Pursuing MBBS in Meghalaya is an excellent pathway for medical aspirants 
              who prefer structured academics, peaceful learning environments, and 
              strong community-based clinical exposure. The state offers 
              NMC-recognized medical colleges equipped with modern laboratories, 
              advanced teaching systems, and experienced medical faculty.
              <br /><br />
              Students gain hands-on learning through hospital rotations, public 
              health programs, and diverse patient interactions across Meghalaya’s 
              major regions. With reliable NEET counseling assistance and 
              transparent admission guidance, All About Doctor Education Pvt Ltd 
              helps students secure MBBS seats in Meghalaya’s leading medical cities.
            </h2>
