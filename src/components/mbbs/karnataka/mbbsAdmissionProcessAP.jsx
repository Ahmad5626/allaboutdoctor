...
const MbbsAdmissionProcessKarnataka = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Guidance for online application, document submission, and verification.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Personalized guidance across top cities: Bengaluru, Mangaluru, Udupi/Manipal, Mysuru, Mandya, Tumakuru, Shivamogga, Davangere, Hubballi–Dharwad, Belagavi, Vijayapura, Bagalkot, Kalaburagi, Ballari, Raichur, Bidar, Hassan, Koppal, Gadag, Haveri, Chikkaballapur, Chikkamagaluru, Chitradurga, Kodagu, Karwar, Yadgir, Ramanagara, Chamarajanagar, Kolar.",
      ],
    },
    {
      ...
      details: [
        ...
        "Patient flow and hospital exposure",
      ],
    },
    {
      title: "4. Seat Allotment Monitoring",
      details: [
        "Real-time support until allotment is confirmed.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Support for physical reporting, documentation, and college joining.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Karnataka</span>
        </h1>
...
export default MbbsAdmissionProcessKarnataka;
