...
const CareerAfterMBBSKarnataka = () => {
  const careers = [
    {
    ...
    },
    {
      ...
      title: "Clinical practice in private or corporate hospitals",
    },
    {
    ...
    },
    {
      ...
      title: "Research, academics & public health careers",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Karnataka</span>
        </h1>
...
export default CareerAfterMBBSKarnataka;
