...
const MbbsAdmissionProcessSikkim = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Guidance for online registration, document submission & verification on the applicable NEET counseling portal.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Personalized selection guidance focusing on institutions in Gangtok.",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Complete tracking through all counseling rounds until final seat allotment.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Support with physical reporting, document verification & fee payment.",
      ],
    },
    {
      ...
      details: [
        ...
        "Travel assistance",
        "Academic onboarding",
        "NExT exam preparation guidance",
      ],
    },
  ];
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Sikkim</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd supports students across each step of the admission journey.
        </p>
...
export default MbbsAdmissionProcessSikkim;
