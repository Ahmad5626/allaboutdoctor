...
const MbbsAdmissionProcessMaharashtra = () => {
  const steps = [
    {
      title: "1. Counseling Registration",
      details: [
        "Support for online form filling and document upload on CET Cell Maharashtra and MCC portals.",
      ],
    },
    {
      title: "2. College Selection Based on NEET Rank",
      details: [
        "Personalized guidance across major cities including: Mumbai, Navi Mumbai, Pune, Nagpur, Nashik, Kolhapur, Sangli, Aurangabad, Solapur, Ahmednagar, Jalgaon, Wardha, Amravati, and more.",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Real-time tracking across all counseling rounds until final seat allocation.",
      ],
    },
    {
      title: "5. Reporting & Admission Completion",
      details: [
        "Assistance with physical reporting, document submission, fee payment, and joining procedures.",
      ],
    },
    {
  ...
  return (
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-12">
        ...
        >
          MBBS Admission Process in <span className="text-primary">Maharashtra</span>
        </h1>

        <p className="text-muted-foreground text-base md:text-lg mb-6 max-w-3xl">
          All About Doctor Education Pvt Ltd supports students throughout the entire admission journey.
        </p>
...
export default MbbsAdmissionProcessMaharashtra;
