...
const MbbsDurationStructureMaharashtra = () => {
  const points = [
    ...
    "Learning Methods Include: Classroom lectures, Clinical postings, Ward rounds, Diagnostic & procedural training, Skill lab simulations, Community health exposure.",
    "Internship: Students undergo structured rotations across leading medical hubs like Mumbai, Pune, Nagpur, Nashik, Kolhapur, Sangli, Aurangabad, and Thane for comprehensive clinical experience.",
  ];
    ...
    <section className="px-4 md:px-8 bg-primary/5 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="mt-4 text-muted-foreground text-lg max-w-3xl">
          The MBBS curriculum in Maharashtra follows the NMC’s competency-based framework:
        </p>
...
export default MbbsDurationStructureMaharashtra;
