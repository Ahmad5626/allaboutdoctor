...
const CareerAfterMBBSBihar = () => {
  const careers = [
    ...
    },
    {
      ...
      title: "Government doctor postings",
    },
    {
    ...
    },
    {
      ...
      title: "International exams (USMLE, PLAB, AMC, DHA, HAAD)",
    },
    {
      icon: <Microscope className="w-8 h-8 text-primary" />,
      title: "Research, teaching & academic roles",
    },
  ];
    ...
    <section className="px-4 md:px-8 border-b border-primary/20">
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <span className="text-primary">MBBS in Bihar</span>
        </h1>
...
export default CareerAfterMBBSBihar;
