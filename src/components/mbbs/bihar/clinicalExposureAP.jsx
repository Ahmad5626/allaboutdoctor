    ...
    <section className="px-4 md:px-8 border-b border-primary/20 bg-primary/5">
      <div className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Bihar’s major medical training hubs offer strong clinical exposure in cities such as:
        </p>
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mb-4">
          Clinical departments covered during internships include:
        </p>
        ...
        <p className="mt-6 text-foreground/80 text-lg">
          Internships include department-wise rotations under experienced clinical mentors.
        </p>
      </div>
    </section>
  );
...
export default ClinicalExposureBihar;
