export default function BiharHero() {
  return (
        ...
        <div className="space-y-6">
          ...
          <div className="pt-0 space-y-4 ">
            <p className="mt-4 text-muted-foreground text-lg md:text-xl">
              Pursuing MBBS in Bihar is an excellent opportunity for medical
              aspirants seeking strong academic learning, affordable fees, and
              extensive clinical exposure. The state hosts several
              NMC-approved medical colleges equipped with modern infrastructure,
              updated teaching methodologies, and high patient flow.
              <br /><br />
              ...
              Bihar’s top medical education cities.
            </p>
          </div>
        </div>
