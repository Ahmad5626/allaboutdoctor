          ...
          <div className="space-y-4">
           <span
            ...
            style={{ animationDelay: "100ms" }}>
              NEET PG – Your Gateway to
Postgraduate Medical Education with <span className="text-primary">All About Doctor
Education Pvt Ltd
</span> 
            </h1>
        ...
        NEET PG (National Eligibility cum Entrance Test – Postgraduate) is the mandatory
entrance exam for doctors seeking admission to MD, MS, PG Diploma, and DNB
courses in India. At All About Doctor Education Pvt Ltd, we guide medical graduates
through every step of the NEET PG journey, helping you secure seats in top medical
