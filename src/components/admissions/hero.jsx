    ...
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        <h1
            ...
            >
           Admissions Services <span className="text-primary">About All About Doctor Education Pvt Ltd</span> 
            ...
            <p className="text-lg md:text-xl text-primary font-semibold">
            Admission assistance for MBBS, BDS, BAMS, BVSc, and other medical programs abroad.
          </p>
        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
          At All About Doctor Education Pvt Ltd, we offer end-to-end support for students seeking admissions in top NMC-approved medical universities worldwide. From shortlisting universities to securing your admission and preparing for departure, we make the process smooth, transparent, and stress-free.
