    ...
    <header className="relative overflow-hidden border-b border-border">
      <div className="relative mx-auto max-w-7xl px-6 py-10 md:py-10">
        ...
        <h1
            ...
            >
         Medical Tourism Services <span className="text-primary">About All About Doctor Education Pvt Ltd</span> 
            ...
            <p className="text-lg md:text-xl text-primary font-semibold">
          Help for patients and students traveling abroad for study or treatment.

          </p>
        <p className="mt-4 max-w-2xl text-sm/6 md:text-base/7 text-muted-foreground">
           At All About Doctor Education Pvt Ltd, we provide comprehensive support for medical tourism, assisting patients seeking advanced medical care abroad and students traveling for medical education. Our services ensure a smooth, safe, and well-organized experience from start to finish.
        </p>
