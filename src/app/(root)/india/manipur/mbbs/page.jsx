...
export const metadata = {
  title: "MBBS in Manipur - All About Doctor",
  description:
    "Get expert guidance for MBBS in Manipur. Explore colleges, fees, cutoffs and admission support with All About Doctor Education Pvt Ltd. Apply now for free counseling. ",
    alternates: {
    canonical: "https://www.allaboutdoctor.in/india/manipur/mbbs",
  },
};
const page = () => {
  return (
